import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as t,c as l,d as n,e as s,a as p,b as r}from"./app-YTsIUs7p.js";const o={},u=n("h1",{id:"一主多子项目配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#一主多子项目配置","aria-hidden":"true"},"#"),s(" 一主多子项目配置")],-1),c={href:"https://github.com/ihub-pub/multi-template",target:"_blank",rel:"noopener noreferrer"},d=r(`<h2 id="配置-wrapper" tabindex="-1"><a class="header-anchor" href="#配置-wrapper" aria-hidden="true">#</a> 配置 wrapper</h2><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">distributionUrl</span><span class="token punctuation">=</span><span class="token value attr-value">https\\://services.gradle.org/distributions/gradle-8.5-bin.zip</span>
