import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as t,c as r,d as n,e as s,a as p,b as l}from"./app-YTsIUs7p.js";const o={},u=n("h1",{id:"a-master-multi-subproject-configuration",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#a-master-multi-subproject-configuration","aria-hidden":"true"},"#"),s(" A master multi-subproject configuration")],-1),c={href:"https://github.com/ihub-pub/multi-template",target:"_blank",rel:"noopener noreferrer"},d=l(`<h2 id="configure-wrapper" tabindex="-1"><a class="header-anchor" href="#configure-wrapper" aria-hidden="true">#</a> Configure wrapper</h2><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">distributionUrl</span><span class="token punctuation">=</span><span class="token value attr-value">https\\://services.gradle.org/distributions/gradle-8.5-bin.zip</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function b(v,g){const a=i("ExternalLinkIcon");return t(),r("div",null,[u,n("p",null,[s("A primary multi-subproject configuration, see"),n("a",c,[s("project template"),p(a)])]),d])}const k=e(o,[["render",b],["__file","multiAdvanced.html.vue"]]);export{k as default};
