import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as t,c as l,d as n,e as s,a as p,b as r}from"./app-DR86wGH8.js";const o={},u=n("h1",{id:"一主多子项目配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#一主多子项目配置","aria-hidden":"true"},"#"),s(" 一主多子项目配置")],-1),c={href:"https://github.com/ihub-pub/multi-template",target:"_blank",rel:"noopener noreferrer"},d=r(`<h2 id="配置-wrapper" tabindex="-1"><a class="header-anchor" href="#配置-wrapper" aria-hidden="true">#</a> 配置 wrapper</h2><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">distributionUrl</span><span class="token punctuation">=</span><span class="token value attr-value">https\\://services.gradle.org/distributions/gradle-8.7-bin.zip</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function b(v,g){const a=i("ExternalLinkIcon");return t(),l("div",null,[u,n("p",null,[s("一个主多子项目配置，参见"),n("a",c,[s("项目模板"),p(a)])]),d])}const k=e(o,[["render",b],["__file","multiAdvanced.html.vue"]]);export{k as default};
