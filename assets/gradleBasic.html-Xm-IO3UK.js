import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as l,c as r,d as n,e as a,a as e,b as o}from"./app-YTsIUs7p.js";const p={},c=n("h1",{id:"gradle基础入门",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#gradle基础入门","aria-hidden":"true"},"#"),a(" Gradle基础入门")],-1),d=n("code",null,"Gradle",-1),u={href:"https://ant.apache.org/",target:"_blank",rel:"noopener noreferrer"},v={href:"https://maven.apache.org/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://groovy.apache.org/",target:"_blank",rel:"noopener noreferrer"},g={href:"https://gradle.org/maven-vs-gradle/",target:"_blank",rel:"noopener noreferrer"},b=n("img",{src:"https://gradle.org/images/gradle-vs-maven.gif",alt:"Gradle vs Maven",tabindex:"0",loading:"lazy"},null,-1),k=n("figcaption",null,"Gradle vs Maven",-1),h=o(`<h2 id="配置-wrapper" tabindex="-1"><a class="header-anchor" href="#配置-wrapper" aria-hidden="true">#</a> 配置 wrapper</h2><blockquote><p>推荐使用<code>wrapper</code>的方式配置 Gradle<br> 环境，便于保持项目环境统一，在项目根目录下添加<code>gradle/wrapper/gradle-wrapper.properties</code>配置文件，详细配置见入门文档，配置内容如下：</p></blockquote><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">distributionUrl</span><span class="token punctuation">=</span><span class="token value attr-value">https\\://services.gradle.org/distributions/gradle-8.5-bin.zip</span>
